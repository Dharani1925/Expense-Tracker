...
const API_BASE = "https://expense-tracker-backend-eodp.onrender.com/api";
const getAuthHeader = () => {
...
const Dashboard = () => {
  // get refresh Transaction from the outlet context
  const { 
  ...
  const prevTimeFrameRange = useMemo(
    () => getPreviousTimeFrameRange(timeFrame), [timeFrame]
    );
    // function to check if a data is within the range
    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.pieChartContainer}>
        ...
        <div className={dashboardStyles.listsGrid}>
          ...
          <div className={dashboardStyles.listContainer}>
            <div className={dashboardStyles.listHeader}>
              <h3 className="text-lg md:text-xl lg:text-xl xl:text-xl font-bold text-slate-100 md:mt-3 mt-3 flex items-center gap-3">
                <ArrowDown className="w-6 h-6 text-green-500" /> Recent Expenses{" "}
                <span className={dashboardStyles.listSubtitle}> ({timeFrameRange.label})</span>
              </h3>
